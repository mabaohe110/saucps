...
function deleteById(obj){
    ...
    if(confirm(msg) == true){
        ...
        $.ajax({
            ...
            url: "/general-party-branch/delete/"+id,
            type: "DELETE",
            data: {},
            dataType: "JSON",
...
function updateById() {
    ...
    $.ajax({
        url: "/general-party-branch/info/"+id,
        type: "get",
        data:{},
        dataType:"JSON",
        success: function (data) {
            var info = data["generalPartyBranch"];
            update_add(info);
        }
    });
...
function update_submit() {
    ...
    if(confirm(msg) == true){
        $.ajax({
            ...
            url: "/general-party-branch/update",
            success: function(response,status,xmlHttpRequest) {
                if(xmlHttpRequest.status == 204){
                    alert("修改成功");
                }else{
                ...
                location.href="general_branch.html";
            }
        });
    }
}
