function select(pageNum){
    ...
    $.ajax({
        url: "/user/userVMListByBranchId",
        type: "get",
        data:{branchId: sessionUser.branchId,roleName: "普通党员",pageNum: pageNum},
        dataType:"JSON",
        async: false,
...
function update_add(user) {
    ...
    $.ajax({
        type: "get",
        data: {},
        url: "/party-branch/info/"+bId,
        dataType:"JSON",
        async: false,
        success: function(data) {
            document.getElementById("update_branch").value = data["partyBranch"].name;
            document.getElementById("update_bId").value = data["partyBranch"].id;
    ...
    document.getElementById("update_roleName").value = user.roleName;
}
...
function update_submit() {
    ...
    var user = {
        ...
        branchId: document.getElementById("update_bId").value,
    ...
    if(confirm(msg) == true){
        $.ajax({
            ...
            success: function(response,status,xmlHttpRequest) {
                ...
                location.href="branch_head.html";
            }
        });
    }
}
...
function add() {
    ...
    $.ajax({
        ...
        async: false,
        success: function(data) {
            document.getElementById("add_branch").value = data["partyBranch"].name;
            document.getElementById("add_bId").value = data["partyBranch"].id;
...
function add_submit() {
    ...
    var user = {
        ...
        branchId: document.getElementById("add_bId").value,
